...
public static class ToolLook
{
    ...
    public static string Title(ToolKind kind) => kind switch
    {
        ...
        ToolKind.Antigravity => "Antigravity CLI",
        _ => kind.ToString(),
    };
    ...
    public static Color Color(ToolKind kind) => kind switch
    {
        ...
        ToolKind.Antigravity => Windows.UI.Color.FromArgb(255, 78, 134, 247),
        _ => Colors.Gray,
    };
    ...
    public static string LogoPath(ToolKind kind) => kind switch
    {
        ...
        ToolKind.Antigravity => "M12 3.6 2.4 20.4h4.2L12 10.8l5.4 9.6h4.2L12 3.6Z",
