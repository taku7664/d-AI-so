...
- **Gemini CLI 제공자**: 인증(`oauth_creds.json`)·세션(`tmp/*/chats/*.jsonl`)·사용량·GEMINI.md 컨텍스트·resume. 요약 카드 셋, 터미널 `Gemini 열기`, 세션 필터·컨텍스트 토글에 Gemini. 메시지 줄 형식은 fixture 기준이라 실제 대화 파일이 생기면 대조 필요 (ARCHITECTURE §4.5)
- 빌드 경고 0 / 오류 0, 테스트 302건 + Slow 2건 통과 (2026-09-08)
